...
one_questions_ib = InlineKeyboardButton(text='1️⃣Первый вопрос',
                                        callback_data='first_questions')

two_questions_ib = InlineKeyboardButton(text='2️⃣Второй вопрос',
                                        callback_data='second_questions')

three_questions_ib = InlineKeyboardButton(text='3️⃣Третий вопрос',
                                          callback_data='third_questions')

four_questions_ib = InlineKeyboardButton(text='4️⃣Четвёртый вопрос',
                                         callback_data='fourth_questions')

five_questions_ib = InlineKeyboardButton(text='5️⃣Пятый вопрос',
                                         callback_data='fiveth_questions')

six_questions_ib = InlineKeyboardButton(text='6️⃣Шестой вопрос',
                                        callback_data='sixth_questions')

seven_questions_ib = InlineKeyboardButton(text='7️⃣Седьмой вопрос',
